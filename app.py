# ==============================================================================
# FINAL, ALL-IN-ONE PRODUCTION SCRIPT (All Features Restored)
# ==============================================================================
...
def simulate_price_history(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Use a subset of the dataframe for performance if it's very large
...
def main():
    ...
    if st.session_state.offer_placed:
        ...
        # This now uses a single source of truth from session_state for the radio button
