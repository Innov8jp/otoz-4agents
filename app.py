...
INTENTS_FILE_PATH = 'intents_200.json'  # updated to your intents file name  # ensure this matches your intents file name
...
def show_price_trend(prices: pd.Series):
    ...
    chart = alt.Chart(df).mark_line(point=True).encode(
        x='Date:T', y='Price:Q'
    ).properties(title='6-Month Price Trend')
